...
@section('content')
            ...
            <form action="{{ route('estructuras.store') }}" method="POST" id="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div class="bs-example">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show" id="experiencia">
                            <h4 class="mt-2">Expeiencia</h4>
                        ...
                        <div class="tab-pane fade show" id="asignacion">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <select  name="cargo_campana_id" class="custom-select" id="cargo_campana" required>
                                ...
                                <div class="col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <select  name="area_id" class="custom-select"  id="area" required>
                                        <option value="">Area
                                        </option>
                                ...
                                <div class="col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <select  name="distrito_federal_asignado"  class="custom-select " id="distrito_federal_asignado" >
   ...
   @foreach (App\Models\DistritoFederal::get() as $distrito)
                                ...
                                <div class="col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <select   name="distrito_local_asignado" class="custom-select" id="distrito_local_asignado" >
 ...
 <div class="col-sm-4 col-md-4 col-xs-12">
                                    ...
                                    <select  name="seccion_asignado"  class="custom-select" id="seccion_asignada" >
